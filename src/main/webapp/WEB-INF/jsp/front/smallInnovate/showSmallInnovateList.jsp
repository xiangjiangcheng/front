...
<link rel="stylesheet" href="${basePath }static/web/css/front/guichenglist.css">
</head>
<body oncontextmenu=self.event.returnValue=false>
    ...
    <div class="main">
            <ul class="ul_box">
            	<c:forEach items="${smallInnovateList }" var="smallInnovate">
            		 <li><span class="num"></span> <span class="model"><a class="link" href="${basePath }rest/moduleform/toSmallInnovateDetails?id=${smallInnovate.id}">${smallInnovate.achievementname }</a></span></li>
            	</c:forEach>
            </ul>
    </div>
	</div>
